...
//=======INITIALIZING FUNCTION=======
           ...
           function init(){
				...
				geo_layer = new OpenLayers.Layer.Vector("Wards", {
					...
					version: "1.1.0",
					url: "http://localhost:8080/geoserver/wfs?service=wfs&version=1.1.0&request=GetFeature&typeNames=cite:osiedla_ward2000&propertyName=name",            
					featurePrefix: "cite",
					featureType: "osiedla_ward2000",
                ...
                map.setCenter(new OpenLayers.LonLat(16.92, 52.41).transform(geographic,mercator), defaultZoom);
